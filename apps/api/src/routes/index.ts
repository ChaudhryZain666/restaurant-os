...
import { printJobRouter } from "./printJob.routes.js";
...
apiRouter.use("/restaurants/:restaurantId/printers", printerRouter);
apiRouter.use("/restaurants/:restaurantId/print-jobs", printJobRouter);
